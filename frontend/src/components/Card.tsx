  ...
  return (
    <>
      {isLoading ? (
        ...
        <div
          className={`w-full h-[8vh] md:h-full px-5 py-2 flex flex-col justify-center gap-2 items-start bg-[#ecd1b2] text-black transition duration-200 border border-[#ecd1b2] hover:bg-[white] hover:text-[#0b421a] rounded-md`}
        >
          <div className="text-2xl font-light md:font-medium">
            {numericData}
          </div>
