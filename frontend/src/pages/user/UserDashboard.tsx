      ...
      <div className="w-full h-fit flex items-center justify-center gap-6 text-black border-b-[0.7px] border-gray-300">
        <NavLink
          ...
          className={({ isActive }) =>
            `${
              isActive
                ? "border-b-[2px] border-black text-black font-medium"
                : "text-gray-500 font-light hover:border-b-[2px] hover:border-gray-300 duration-50"
            } py-3 h-full transition-all duration-200 tracking-wide`
          }
        >
          Quests
        </NavLink>
