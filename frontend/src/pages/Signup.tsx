...
export const Signup = () => {
    const [signupData, setSignupData] = useState<AuthState>({ username: "", password: "",firstname: "",lastname: "" });
    ...
    const onSubmitFunction = async () => {
        try {
            ...
            if (signupData.firstname === undefined || signupData.firstname?.trim() === "") {
                toast.error("First Name Cannot be null");
                return;
            }
            if (signupData.lastname === undefined || signupData.lastname?.trim() === "") {
    ...
    return (
        <div className="w-screen h-screen flex justify-center items-center bg-cover bg-right"
            ...
            <div className="bg-white px-10 py-5 text-gray-700 rounded-md">
                ...
                <fieldset className="fieldset md:w-[25vw] mt-4">
                    ...
                    <div className="border rounded-sm">
                        <input name="firstname" onChange={onChangeFunction} type="text" className="input focus:outline-none bg-white p-2" placeholder="Enter First Name" />
                    </div>
                </fieldset>
                <fieldset className="fieldset md:w-[25vw]">
                    <legend className="fieldset-legend text-gray-700">Last Name</legend>
                    <div className="border rounded-sm">
                        <input name="lastname" onChange={onChangeFunction} type="text" className="input focus:outline-none bg-white p-2" placeholder="Enter Last Name" />
                    </div>
                </fieldset>
                <fieldset className="fieldset md:w-[25vw]">
                ...
                <fieldset className="fieldset md:w-[25vw]">
                    <legend className="fieldset-legend text-gray-700">Set Your Password</legend>
                ...
                <div className="flex justify-between items-center mt-5 text-sm">
                    <Link to="/login" className="text-blue-500 text-wrap">Already have an account?</Link>
                    <button className=" bg-gray-600 text-white py-1 px-2 md:py-2 md:px-4 rounded-4xl hover:text-gray-600 hover:bg-white cursor-pointer" onClick={onSubmitFunction}>Signup</button>
                </div>
            </div>
