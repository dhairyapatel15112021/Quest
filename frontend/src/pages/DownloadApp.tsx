...
export const DownloadApp = () => {
    const appStoreUrl = "https://apps.apple.com/in/app/starbucks-india/id1210203958";
    const googlePlayUrl = "https://play.google.com/store/apps/details?id=com.starbucks.in&hl=en_IN";

    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-8 bg-[#f8f7f3] font-sans">
            <div className="max-w-5xl text-center">
                <div className="mb-4">
                    <img src={logo} alt="App Logo" className="w-16 h-16 rounded-xl mx-auto" />
                </div>

                <h1 className="text-4xl font-bold text-gray-800 mb-4">Get Starbucks for Mobile</h1>

                <p className="text-lg text-gray-600 mb-8 leading-relaxed max-w-xl mx-auto">
                    Get started with Starbucks Rewards Program in seconds, download the app and join the
                    Quest.
                </p>
                ...
                <div className="flex justify-center mt-8 max-w-full">
                    <img src={appScreenshot} alt="App Screenshot" className="max-w-3xl w-full h-auto md:max-w-full" />
                </div>
            </div>
        </div>
    );
